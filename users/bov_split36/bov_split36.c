...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_bov_split42(
        ...
        XXXXXXX, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                               KC_N,    KC_M,    COMMA,   DOT,     KC_ENT,  XXXXXXX,
                                            KC_LCMD, LA_SYM,  KC_LSFT,          KC_SPC,  LA_NAV,  KC_LALT   
    ),
    
    [_SYM] = LAYOUT_bov_split42(
        XXXXXXX, DK_EXLM, AT,      DK_HASH, DLR,     DK_PERC,                            DK_LPRN, DK_RPRN, DK_CIRC, DK_QUES, DK_TILD, XXXXXXX,
        XXXXXXX, DK_AMPR, DK_ASTR, DK_UNDS, DK_QUOT, DK_DQUO,                            LCBR,    RCBR,    DK_DIAE, DK_ACUT, DK_GRV,  XXXXXXX,
        XXXXXXX, PIPE,    DK_PLUS, DK_MINS, DK_EQL,  BSLS,                               DK_LBRC, DK_RBRC, DK_SCLN, DK_COLN, DK_SLSH, XXXXXXX,
                                            _______, _______, _______,          _______, _______, _______
    ),
    
    [_NAV] = LAYOUT_bov_split42(
        XXXXXXX, KC_TAB,  KC_7,    KC_8,    KC_9,    KC_COMM,                            KC_PGUP, KC_HOME, KC_UP,   KC_END,  XXXXXXX, XXXXXXX,
        XXXXXXX, KC_ESC,  KC_4,    KC_5,    KC_6,    KC_DOT,                             KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL,  XXXXXXX,
        XXXXXXX, XXXXXXX, KC_1,    KC_2,    KC_3,    KC_0,                               XXXXXXX, DK_AE,   DK_OE,   DK_AA,   KC_ENT,  _______,
                                            _______, _______, _______,          _______, _______, _______
    ),

    [_FUN] = LAYOUT_bov_split42(
        XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F4,   XXXXXXX,                            XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX, KC_F5,   KC_F6,   KC_F7,   KC_F8,   XXXXXXX,                            KC_LCTL, KC_LALT, KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX,
