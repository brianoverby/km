...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_bov_split42(
        ...
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                               KC_N,    KC_M,    KC_COMM, KC_DOT,  DK_SLSH, KC_TAB,
    ...
    [_NAV] = LAYOUT_bov_split42(
        ...
        _______, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,                             KC_F11,  KC_F12,  COMMA,   DOT,     XXXXXXX, _______,
